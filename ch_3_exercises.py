...
c_age = int(input("How old is the customer?   "))
...
print("Your cost for a customer who is " + str(c_age) + " years old")
...
if tired:
    ...
    status = "Eyes Open"
if hungry:
    status = status + " and Crying "
else:
    status = status + " and Quiet? "
    print(status)
    print(tired)
    print(hungry)
