def main():
    ...
    calculate_total_monthly_cost(monthly_loan_payment, monthly_insurance_payment, monthly_gas_payment,
...
def calculate_total_monthly_cost(payment1, payment2, payment3, payment4):
    ...
    print("You spend $", + total_monthly_cost, "on your car each month.")
    calculate_total_annual_cost(total_monthly_cost)


def calculate_total_annual_cost(total_monthly_cost):
    total_annual_cost = total_monthly_cost * 12
    print("You spend $", + total_annual_cost, "per year on your car.")
