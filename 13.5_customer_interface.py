...
class IceCreamGUI:
    ...
    def calc_menu(self):
        ...
        if self.radio_var.get() == 1:
            ...
            order_total = 2
        if self.sprinkles_var.get() == 1:
            order_total += 1
        if self.chips_var.get() == 1:
            order_total += 2
        if self.dough_var.get() == 1:
            order_total += 3
        if self.scoop_var.get() == 1:
            order_total += 4
        if self.fudge_var.get() == 1:
            order_total += 2
        if self.caramel_var.get() == 1:
            order_total += 2

            self.drink_cost.set("Order Total: $()".format(order_total))


IceCream_gui = IceCreamGUI()
